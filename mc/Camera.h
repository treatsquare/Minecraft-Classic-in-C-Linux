...
void create_projection(Camera* cam)
{
 ...
 void mul_vec_and_add(vec3 vec1, vec3 vec2, const float fl)
{
    vec3 cvec;
    vec3 rvec;
 ...
 void mul_vec_and_sub(vec3 vec_1, vec3 vec_2, const float fl)
{
    vec3 cvec;
    vec3 rvec;
    cvec[0] = fl; cvec[1] = fl; cvec[2] = fl;
 ...
 void add_norm_cross_mul(vec3 vec_1, vec3 vec_2, vec3 vec_3, const float fl)
{
 ...
 void sub_norm_cross_mul(vec3 vec_1, vec3 vec_2, vec3 vec_3, const float fl)
{   
    vec3 cvec;
    vec3 rvec;
    cvec[0] = fl; cvec[1] = fl; cvec[2] = fl;
